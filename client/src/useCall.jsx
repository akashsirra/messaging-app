...
// Public STUN alone can't traverse many routers/networks — a TURN server
// relays the media when a direct peer connection can't be established.
// OpenRelay's free TURN service is used here as a fallback.
const ICE_SERVERS = {
  iceServers: [
